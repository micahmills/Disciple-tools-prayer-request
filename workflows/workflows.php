...
/**
 * Class Disciple_Tools_Prayer_Requests_Workflows
 *
 * @since  1.11.0
 */
class Disciple_Tools_Prayer_Requests_Workflows {
    ...
    /**
     * Disciple_Tools_Prayer_Requests_Workflows The single instance of Disciple_Tools_Prayer_Requests_Workflows.
     *
     * @var    object
     * @access private
     * @since  1.11.0
    ...
    /**
     * Main Disciple_Tools_Prayer_Requests_Workflows Instance
     *
     * Ensures only one instance of Disciple_Tools_Prayer_Requests_Workflows is loaded or can be loaded.
     *
     * @return Disciple_Tools_Prayer_Requests_Workflows instance
     * @since  1.11.0
     */
    ...
    /**
     * Disciple_Tools_Prayer_Requests_Workflows constructor.
     */
        ...
        $workflows[] = (object) [
            ...
            'actions'    => [
                Disciple_Tools_Workflows_Defaults::new_action( Disciple_Tools_Workflows_Defaults::$action_update,
                    [
                        'id'    => 'disciple_tools_prayer_requests_text',
                        'label' => $dt_fields['disciple_tools_prayer_requests_text']['name']
                    ], [
...
Disciple_Tools_Prayer_Requests_Workflows::instance();
